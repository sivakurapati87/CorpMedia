							...
							<div class="row">
								<div class="col-md-5">
									...
									<div class="w3-container w3-border"
										...
										<p>
											<font size="1">Tax Free,Max limit: Rs.{{medicalreimbursement.maxAnnualLimit}} </font>&nbsp;&nbsp;&nbsp;<a href=""
												data-toggle="modal" data-target="#medicalmodelpopupid"><i
												class="fa fa-cog"></i> </a>
										</p>
									</div>
									...
									<div class="w3-container w3-border"
										...
										<p>
											<font size="1">Tax Free, Max Limit : Rs.{{transportallowance.maxAnnualLimit}}</font>&nbsp;&nbsp;&nbsp;<a
												href="" data-toggle="modal" data-target="#transportmodelpopupid"><i
												class="fa fa-cog"></i></a>
										</p>
									</div>
									...
									<div class="modal fade" id="transportmodelpopupid" role="dialog">
										<div class="modal-dialog">
									...
									<div class="w3-container w3-border"
										...
										<p>
											<font size="1">Tax Free, Max Limit: Rs.{{professionalallowance.maxAnnualLimit}}</font>&nbsp;&nbsp;&nbsp;<a
												href="" data-toggle="modal" data-target="#professionalmodelpopupid"><i
												class="fa fa-cog"></i></a>
										</p>
									</div>
									...
									<div class="modal fade" id="professionalmodelpopupid" role="dialog">
										<div class="modal-dialog">
									...
									<div class="w3-container w3-border"
										...
										<p>
											<font size="1">Tax Free, Max Limit: Rs.{{travelreimbursement.maxAnnualLimit}}</font>&nbsp;&nbsp;&nbsp;<a
												href="" data-toggle="modal" data-target="#travelmodelpopupid"><i
												class="fa fa-cog"></i></a>
										</p>
									</div>
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="form-group">
														...
														<br> <label for="medical_sel2">Require
																submission of bills to claim this allowance:</label> <select
																 class="form-control" id="medical_sel2" ng-model="travelreimbursement.requireSubmissionId"
																ng-options="bank.lookupDetailId as bank.description for bank in  lookup.trueorfalseList">
															<option value="" disabled selected>Select</option>
									...
									<div class="w3-container w3-border"
										...
										<h>Food coupons</h>
										<p>
											<font size="1">Tax Free, Max Limit: Rs.{{foodcoupons.maxAnnualLimit}}</font>&nbsp;&nbsp;&nbsp;<a
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="form-group">
														...
														<br> <label for="medical_sel2">Require
																submission of bills to claim this allowance:</label> <select class="form-control" id="medical_sel2" ng-model="foodcoupons.requireSubmissionId"
																ng-options="bank.lookupDetailId as bank.description for bank in  lookup.trueorfalseList">
																<option value="" disabled selected>Select</option>
									...
									<div class="w3-container w3-border"
										...
										<p>
											<font size="1">Tax Free, Max Limit: Rs.{{citycompensatoryallowance.maxAnnualLimit}}</font>&nbsp;&nbsp;&nbsp;<a
									...
									<div class="modal fade" id="citymodelpopupid" role="dialog">
										<div class="modal-dialog">
											...
											<div class="modal-content">
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal">&times;</button>
													<h4 class="modal-title">Edit City Compensatory Allowance</h4>
												</div>
												<div class="modal-body">
													<div class="form-group">
														<p class="form-controll">
															Maximum annual limit Rs.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
																type="number" ng-model="citycompensatoryallowance.maxAnnualLimit">
														</p>
														<br> <label for="medical_sel2">Require
																submission of bills to claim this allowance:</label> <select class="form-control" id="medical_sel2" ng-model="citycompensatoryallowance.requireSubmissionId"
																ng-options="bank.lookupDetailId as bank.description for bank in  lookup.trueorfalseList">
																<option value="" disabled selected>Select</option>
									...
									<div class="w3-container w3-border"
										...
										<h>Daily allowance</h>
										<p>
											<font size="1">Tax Free, Max Limit: Rs.{{dailyallowance.maxAnnualLimit}}</font>&nbsp;&nbsp;&nbsp;<a
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<div class="form-group">
														...
														<br> <label for="medical_sel2">Require
																submission of bills to claim this allowance:</label> <select class="form-control" id="medical_sel2" ng-model="dailyallowance.requireSubmissionId"
																ng-options="bank.lookupDetailId as bank.description for bank in  lookup.trueorfalseList">
																<option value="" disabled selected>Select</option>
								...
								<div class="col-md-5">
									...
									<div class="w3-container w3-border"
										...
										<a href="" data-toggle="modal" data-target="#custommodelpopupid">
										...
										<div class="modal fade" id="custommodelpopupid" role="dialog">
											<div class="modal-dialog">
                                                 <form ng-submit="saveCustomAllowance()" class="form-horizontal" role="form">
												<!-- Modal content-->
												<div class="modal-content">
													<div class="modal-header">
														<button type="button" class="close" data-dismiss="modal">&times;</button>
													...
													<div class="modal-body">
														<div class="row">
																...
																<div class="form-group">
																	...
																	<div class="col-sm-6">
																		<input type="text" class="form-control" id="name" ng-model="customallowance.Name"
																...
																<div class="form-group">
																	<label class="control-label col-sm-4" for="name">Maximum
																		annual limit</label>
																	<div class="col-sm-6">
																		<input type="number"  ng-model="customallowance.maxAnnualLimit" />
																	</div>
																</div>
																...
																<div class="form-group">
																	<label class="control-label col-sm-4" for="benefit">Has
																		tax benefits</label>
																	<div class="col-sm-6">
																		<select class="form-control" id="sel1"ng-model="customallowance.taxBenefitId"
																ng-options="bank.lookupDetailId as bank.description for bank in  lookup.trueorfalseList">
																<option value="" disabled selected>Select</option></select>
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-sm-6">
																		<select class="form-control" id="bill"ng-model="customallowance.submitBillId"
																ng-options="bank.lookupDetailId as bank.description for bank in  lookup.trueorfalseList">
																<option value="" disabled selected>Select</option>
																		</select>
																	</div>
							...
							<div class="row">
								<div class="col-md-5">
									...
									<div class="w3-container w3-border"
										...
										<br>
										<p>
											Employee Gratuity contribution&nbsp;&nbsp;&nbsp;<a href=""
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<div class="form-group">
												<p class="form-controll">
													Maximum annual limit Rs.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
														type="number" ng-model="gratuitycontribution.maxAnnualLimit">
												</p>
												<br>
