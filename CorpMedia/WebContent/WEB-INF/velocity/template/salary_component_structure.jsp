...
<div class="container-fluid" style="width: 100%;">
  ...
  <div class="row">
                <div class="col-md-10">
                    <p><font size="3">Salary components</font></p>
                    <p><font size="2"><b>In this section,you can set up and define properties for salary components.</b></font></p>
                </div>
                <div class="col-md-2">
            ...
            <div class="row">
                <div class="col-md-12">
                    <p><font size="3">Basic components</font></p>
                    <p><font size="2">Basic, HRA & PF are auto calculated based on the individual salary structure to
                        optimize tax savings.
                        Special allowance is used as a bucket for allocating the balance of salary
                        left after allocating all the other allowances and components. 
                        You can edit the name of Special Allowance to suit your needs.
                        </font>
                    </p>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p><font size="3">Recurring Salary Heads</font></p>
                    <p><font size="2">Allowances are the salary components within an Employee Gross Salary.
                        All Statutory tax-exempt allowances are already provided and for most part you do not have to make any changes here.
                        Salary components such as Basic, HRA etc are auto calculated by the system optimized for each employee.</font></p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-5">
                    <p></p>
                    <p><b><font size="3">STANDARD ALLOWANCES</font></b></p>
                    
                    <!--this is first box for medical allowance--> 
                    <div class="w3-container w3-border" style="background-color:#5e6b7c">
                        <p></p>
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                   ...
                   <!--this is second box for transport allowance--> 
                    ...
                    <div class="w3-container w3-border" style="background-color:#5e6b7c">
                        ...
                        <p><font size="1">Tax Free, Max Limit Rs. 19,200</font>&nbsp;&nbsp;&nbsp;<a href="" data-toggle="modal" data-target="#myModal"><i class="fa fa-cog"></i></a></p>
                    </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    ...
                    <div class="w3-container w3-border" style="background-color:#5e6b7c">
                        ...
                        <p><font size="1">Tax Free, Max Limit Rs. 0</font>&nbsp;&nbsp;&nbsp;<a href="" data-toggle="modal" data-target="#myModal"><i class="fa fa-cog"></i></a></p>
                    </div>
 ...
 <!--left blank since we want to make some space-->
                ...
                <div class="col-md-5">
                    ...
                    <p></p>
                    <p><b><font size="3">CUSTOM ALLOWANCES</font></b></p>
                    <div class="w3-container w3-border" style="background-color:#fffff">
                        <br>
                        <!--making it a link since we need to trigger bootstrap modal-->
                        <a href="" data-toggle="modal" data-target="#myModal">
                            <p style="align-self: center"><font size="3">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <i class="fa fa-plus"></i>&nbsp;Add custom allowances</font></p>
                        </a>
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <form class="form-horizontal" role="form">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-sm-4" for="name">Maximum annual limit</label>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-sm-4" for="benefit">Has tax benefits</label>
                                                    <div class="col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-sm-4" for="bill">Requires submit of bill</label>
                                                    <div class="col-sm-6">
            ...
            <br>
            <p><b><font size="3"></font>CONTRIBUTIONS</b></p>
            <div class="row">
                <div class="col-md-5">

                    <div class="w3-container w3-border" style="background-color: gray">
                        <br>
                        <p>Employee Gratuity contribution&nbsp;&nbsp;&nbsp;<a href="" data-toggle="modal" data-target="#myModal_gratuity"><i class="fa fa-cog"></i></a></p>
                        <br>
                    </div>
                    <br>
                </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Edit Employee Gratuity contribution</h4>
        </div>
        <div class="modal-body">
            <div class="form-group">
  <label for="medical_sel1">Enable this component:</label>
