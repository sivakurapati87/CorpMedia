		...
		<tr>
			...
			<td valign="top"><payroll-info-top></payroll-info-top>
				<table class="table mtable  " border="0"
					...
					<tr>
						<th class="th"><h2>Loan Settings</h2></th>
					</tr>
					<tr>
						...
						<td>
							...
							</div> <br> <!--here following portion is controlled by angular js-->
									...
									<div class="col-md-8" style="background-color: greenyellow">
										...
										<p>
											&nbsp; &nbsp; &nbsp; &nbsp;<input type="checkbox">&nbsp;&nbsp;<input
												type="number" style="width: 100px"> &nbsp;&nbsp;days
											from joining
										</p>
										<br>
										<p>
									...
									<div class="col-md-8" style="background-color: greenyellow">
										...
										<p>
											Limit maximum loan amount to maximum of &nbsp;<input
												type="number" style="width: 100px">&nbsp; % of gross
											salary, or Rs. &nbsp;<input type="number"
							...
							</div> <!--this is the whole container for the boxes--> <br>
							<div class="row">
