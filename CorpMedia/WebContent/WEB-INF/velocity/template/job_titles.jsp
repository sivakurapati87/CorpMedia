...
<div class="container-fluid" style="width: 100%;">
  ...
  <div id="fade_out">
        <p><font size="4">Job Titles</font></p>
        <p><font size="2">You can specify employee job title here.</font></p>
        
        
        <div class="row">
            <div class="col-md-2">
                <button id="fader" class="btn btn-primary"><i class="fa fa-plus-square">&nbsp;&nbsp;&nbsp;</i>Add New</button>
            </div>
            <div class="col-md-10">
            </div>
