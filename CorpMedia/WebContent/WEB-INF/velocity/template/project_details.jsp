		...
		<tr>
			...
			<td valign="top">
				...
				<table class="table mtable" border="0"
					...
					<tr><th class="th"><h2>REPORTS</h2></th> <td width="1%"></td> <th class="th"><h2>Project Details</h2></th> </tr>
					<tr>
						...
						<td style="border:solid 1px #ccc; border-style: inset; background:#fefefe;">
							...
							<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-3">
										<p>
											<b><font size="3">Project Details</font></b>
										</p>
									</div>
								...
								<br>
                               <form ng-submit="saveOrUpdateProjectDetails()">
								<div class="row">
										...
										<div class="form-group">
											<label for="date_from">From</label>
											 ...
											 <input type="text" class="form-control"
														ng-model="projectDetailsJson.strFromDate"
									...
									<div class="col-md-3">
										...
										<div class="form-group">
											<label for="date_from">To</label> 
											 <input type="text" class="form-control"
														ng-model="projectDetailsJson.strToDate"
