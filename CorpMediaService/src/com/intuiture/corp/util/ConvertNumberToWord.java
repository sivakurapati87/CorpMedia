...
public class ConvertNumberToWord {
	...
	private static String[] teen = { " Ten", " Eleven", " Twelve", " Thirteen", " Fourteen", " Fifteen", " Sixteen", " Seventeen", " Eighteen",
			" Nineteen" };
	private static String[] tens = { " Twenty", " Thirty", " Forty", " Fifty", " Sixty", " Seventy", " Eighty", " Ninety" };
	private static String[] maxs = { "", "", " Hundred", " Thousand", " Lakh", " Crore" };

	public static String convertNumberToWords(double d) {
		input = numToString(d);
		String converted = "";
		int pos = 1;
		boolean hun = false;
	...
	private static String numToString(double x) // CONVERT THE NUMBER TO STRING
	{
		String num = "";
		while (x != 0) {
	...
	// {
	// ConvertNumberToWord obj=new ConvertNumberToWord();
	// obj.inputNumber();
